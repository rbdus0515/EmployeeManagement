...
public class EmployeeView {
	...
	public void displayMenu() {
		...
		do {
			...
			try {
				...
				// DB 조회 결과를 HachMap<String, Integer>에 옮겨 감아서 반환
				// 부서코드, 급여 합 조회
	...
	private void insertEmployee() throws Exception {
		...
		Employee emp1 = new Employee(empId, empName, empNo, email, phone,
	...
	private void updateEmployee() throws Exception {
		...
		if(result>0) {
			...
			System.out.println("사원 정보가 일치하는 직원이 없습니다.");
		}
